        ...
        <div className="exp">
            ...
            <VerticalTimeline>
                <VerticalTimelineElement
                    ...
                    icon={<FaBriefcase/>}
                >
                    <img src={atol} className="companyIcons" alt=""></img>
                    <h3 className="vertical-timeline-element-title">Backend Engineer</h3>
                    <h6 className="vertical-timeline-element-subtitle">Atolio</h6>
                    <h7 className="vertical-timeline-element-subtitle">Denver, CO, United States</h7>
                    <p>
                        Incoming
                    </p>
                </VerticalTimelineElement>
